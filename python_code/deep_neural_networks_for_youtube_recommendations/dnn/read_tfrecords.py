...
if __name__ == "__main__":
    files = tf.data.Dataset.list_files('\\Users\\Workspace\\python_code\\deep_neural_networks_for_youtube_recommendation\\dnn\\tfrecords\\train\\train.tfrecords', shuffle=True)
