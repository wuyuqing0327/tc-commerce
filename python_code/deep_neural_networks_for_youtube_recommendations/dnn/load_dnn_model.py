...
class dataProcess(object):
    ...
    def next_batch(self, batch_size):
        files = tf.data.Dataset.list_files(
            '\\Users\\Workspace\\python_code\\deep_neural_networks_for_youtube_recommendations\\dnn\\tfrecords\\train\\train.tfrecords', shuffle=False
        )
...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        meta_graph_def = tf.saved_model.loader.load(sess, [tf.saved_model.tag_constants.SERVING],
                                                    "/Users/yuqingwu/Workspace/tc-ecommerce/python_code/deep_neural_networks_for_youtube_recommendations/dnn/modelpath/1575536466")
