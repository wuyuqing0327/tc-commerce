...
if __name__ == "__main__":
    ...
    for i in range(sample_num):
        visit_items_index = np.random.randint(low=0, high=item_num, size=[50])
        continuous_features_value = np.random.uniform(low=-5.0, high=5.0, size=[128])
    ...
    # 训练数据
    filename = "/Users/yuqingwu/Workspace/tc-ecommerce/python_code/deep_neural_networks_for_youtube_recommendations/dnn/tfrecords/train/train.tfrecords"
    ...
    filename = "/Users/yuqingwu/Workspace/tc-ecommerce/python_code/deep_neural_networks_for_youtube_recommendations/dnn/tfrecords/evaluation/evaluation.tfrecords"
    writer = tf.python_io.TFRecordWriter(filename)
    i = 0
    for sample in sample_set:
        if i % 10 == 0:
